...
namespace Microsoft.Xna.Framework
{
    ...
    /// May25 th
    /// Added a couple return chains i forgot about for AppendAt OverwriteAt ect.
    /// ...
    /// </summary>
    public sealed class MgStringBuilder
    {
        private static int decimalCharOffsetFor1 = 48;
        ...
        public static MgStringBuilder operator +(MgStringBuilder msb, MgStringBuilder s)
        {
            msb.StringBuilder.Append(s);
            return msb;
        }
        public static MgStringBuilder operator +(MgStringBuilder msb, string s)
        {
            msb.StringBuilder.Append(s);
            return msb;
        }
        ...
        public MgStringBuilder Append(byte value)
        {
            ...
            while (place > 0)
            {
                ...
                {
                    addzeros = true;
                    stringbuilder.Append((char)((num % (place * 10)) / place + decimalCharOffsetFor1));
                }
                else
                {
        ...
        public MgStringBuilder Append(int value)
        {
            ...
            while (place > 0)
            {
                if (n >= place)
                {
                    ...
                    int val = n % modulator;
                    int dc = val / place;
                    stringbuilder.Append((char)(dc + decimalCharOffsetFor1));
                }
                else
                {
                    if (addzeros) { stringbuilder.Append('0'); }
        ...
        public MgStringBuilder Append(float value)
        {
            ...
            if (value <= -1f || value >= 1f)
            {
                ...
                while (place > 0)
                {
                    ...
                    {
                        addZeros = true;
                        stringbuilder.Append((char)((n % (place * 10)) / place + decimalCharOffsetFor1));
                    }
                    else
                    {
                        if (addZeros) { stringbuilder.Append('0'); }
        ...
        /// </summary>
        public MgStringBuilder OverWriteAt(int index, Char s)
        {
        ...
        /// </summary>
        public MgStringBuilder OverWriteAt(int index, StringBuilder s)
        {
        ...
        /// Functions to overwrite data at the index on
        /// </summary>
        public MgStringBuilder OverWriteAt(int index, String s)
        {
        ...
        /// </summary>
        public MgStringBuilder AppendAt(int index, Char s)
        {
        ...
        /// </summary>
        public MgStringBuilder AppendAt(int index, String s)
        {
            CheckAppendCapacityAndLength(index, s.Length);
