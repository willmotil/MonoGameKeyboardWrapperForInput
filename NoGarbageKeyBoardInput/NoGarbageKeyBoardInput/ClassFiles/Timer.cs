...
namespace Microsoft.Xna.Framework
{
    ...
    public class TriggerableTimer
    {
        ...
        public TriggerableTimer()
        {
            Timer = 1.0f;
            IsActivelyTiming = false;
            isTriggered = false;
        }
        public TriggerableTimer(float seconds)
        {
            Timer = seconds;
            IsActivelyTiming = true;
            isTriggered = false;
        }
        public TriggerableTimer(float seconds, bool startingStateActive)
        {
            Timer = seconds;
